...
export class Login extends React.Component{
  ...
  <p> In each slide there are 10 word pairs. Using "Next" and "Back" you can navigate if you have chosen a category for all pairs in the slide. At the end you will find a "Submit" button to send the results.</p>
